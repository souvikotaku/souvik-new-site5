    ...
    <div style={{ backgroundColor: "black", height: "100%", width: "100%" }}>
      ...
      <div className="container ">
        <div className="row ">
          ...
          >
            <img src={process.env.PUBLIC_URL + "/images/faviconpng.png"} />
          </div>
          <button
            className="btn btn-md carbutton"
            style={{
              color: "white",
          ...
          >
            ...
            >
              ...
              <div style={{ zIndex: "2", position: "absolute" }}>
                <video autoPlay loop className="miniVideo">
                  <source
                    type="video/mp4"
